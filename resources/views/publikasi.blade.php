    ...
    <div class="publikasi-title text-center">
        ...
        <form action="{{url('publikasi')}}" method="GET">
            <div class="search-bar">
                ...
                <input type="text" name="search" placeholder="Cari jurnal, waktu terbit, indeks, atau bidang" value="{{ request('search') }}">
            </div>
        </form>
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-text">
                                ...
                                <a href="{{ $value->link_jurnal }}" target="_blank" class="btn btn-primary">Lihat Jurnal</a>
                            </div>
                        </div>
                    </div>
                </a>
