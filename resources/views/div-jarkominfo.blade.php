...
@section('content')
    <div class="jarkominfo">
        <div class="division-title">
            ...
            <h1>Divisi <br><span>Jaringan Komunikasi dan Informasi</span></h1>
            <ol>
                <li>Mengelola akun media sosial HIMSI untuk menyampaikan informasi terbaru mengenai kegiatan, program dan pengumuman penting.</li>
                <li>Mendokumentasikan setiap kegiatan yang diselenggarakan atau diikuti HIMSI.</li>
            </ol>              
        </div>
        </div>
