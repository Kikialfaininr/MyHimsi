...
@section('content')
    <div class="jarkominfo">
        <div class="division-title">
            ...
            <h1>Divisi <br><span>Kewirausahaan</span></h1>
            <ol>
                <li>Menciptakan kesempatan kewirausahaan, meningkatkan keterampilan berbisnis, dan mendukung anggota himpunan dalam merintis usaha atau proyek yang berorientasi pada keuntungan.</li>
                <li>Melakukan pengembangan ide bisnis, pemantauan pasar dan analisis tren, pelatihan dan pembinaan kewirausahaan, mengelola proyek kewirausahaan, dan menjalin hibungan dengan mitra bisnis.</li>
            </ol>              
        </div>
        </div>
