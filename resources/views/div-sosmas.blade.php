...
@section('content')
    <div class="jarkominfo">
        <div class="division-title">
            ...
            <h1>Divisi <br><span>Sosial dan Kemasyarakatan</span></h1>
            <ol>
                <li>Mengembangkan program-program yang berorientasi pada pelayanan dan pengabdian kepada masyarakat, smelibatkan anggota organisasi dalam kegiatan bakti sosial dan kegiatan amal, kerjasama dengan pihak eksternal, serta kampanye sosial dan edukasi.</li>
            </ol>              
        </div>
        </div>
