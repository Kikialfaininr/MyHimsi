...
@section('content')
    <div class="jarkominfo">
        <div class="division-title">
            ...
            <h1>Divisi <br><span>Pendidikan dan Penalaran</span></h1>
            <ol>
                <li>Bertanggung jawab untuk mengembangkan inisiatif yang bersifat edukatif, seperti publikasi ilmiah, pelatihan dan workshop, bimbingan akademis, dan penyelenggaraan seminar untuk memberikan nilai tambah pada pengalaman akademis dan pengembangan pribadi anggota.</li>
            </ol>              
        </div>
        </div>
